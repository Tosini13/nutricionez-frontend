      ...
      <div className="flex flex-col items-start justify-between md:flex-row">
        <div className="mb-6 md:mr-6 md:mb-0">
          ...
          <Paragraph>
            ...
            Intervenciones y pautas nutricionales específicas para tu patología.
            Resolución de dudas en relación a tu patología.
          </Paragraph>
        </div>
        <div>
